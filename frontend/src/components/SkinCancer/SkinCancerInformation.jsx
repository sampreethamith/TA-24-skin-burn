        ...
        <Row>
          <Col>
            <p className="skin-cancer-informaton-text">
              Skin Cancer is a disease in which cancer cells form in the tissues
              of the skin. The skin has several layers, but the two main layers
              are the upper layer, called the epidermis, and the lower or inner
              layer, called the dermis.
            </p>
            <h4>Skin Cancer devlop</h4>
            <p className="skin-cancer-informaton-text">
              Skin Cancer develops when the cells of the skin are damaged. This
              causes cells to mutate, reproduce abnormally and form a mass of
              cancerous cells. The type of skin cancer that develops depends on
            ...
            <p className="skin-cancer-informaton-text">
              ...
              body that are not normally exposed to these sources of ultraviolet
              light. Exposure to toxic substances or having a weakened immune
              system may also contribute to the development of skin cancer.
            </p>
